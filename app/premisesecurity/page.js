    ...
    <div className="font-manrope">
      ...
      >
        ...
        <div className=" flex items-center flex-col relative h-[860px] py-24">
          ...
          <p className="font-[500] text-[84px] text-white text-center mt-8">
          ...
          <button
            className="flex items-center justify-center py-2 px-3 sm:rounded-xl gap-1 sm:gap-2 text-white mt-10 bg-[#552DDA] rounded-[7px] text-[14px] sm:text-[16px] sm:px-4 sm:py-3 hover:bg-transparent border-[#552DDA] shadow-xl shadow-[#5144DCF7]  border-[3px] hover:!shadow-none"
            style={{
